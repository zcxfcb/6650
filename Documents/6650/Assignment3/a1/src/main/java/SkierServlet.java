...
public class SkierServlet extends HttpServlet {
  ...
  public static final String SKIER_POST_URL = "/skiers/{resortID}/seasons/{seasonID}/days/{dayID}/skiers/{skierID}";
...
//      boolean dbWriteSuccess = true;
      ...
      statsDao.insertLatencyRecord(SKIER_POST_URL, after - before);
    } else {
